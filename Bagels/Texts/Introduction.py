INTRODUCTION = """Bagels is a deduction game in which the player tries to guess a random three-digit number
(with no repeating digits) generated by the computer.
...
EXAMPLE = """The computer can give multiple clues, which are sorted in alphabetical order.
